            ...
            <div className="flex flex-col space-y-4">
              <div className="relative">
                <input 
                  ...
                  className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-md focus:outline-none focus:border-[#ffd700]/70 text-white placeholder:text-gray-400 font-josefin"
                />
                <button className="absolute right-2 top-1/2 transform -translate-y-1/2 px-4 py-1.5 bg-[#ffd700] text-[#2a1048] rounded-md font-cinzel text-xs uppercase tracking-wider hover:shadow-lg transition-all font-medium">
                  Subscribe
                </button>
              </div>
